...
class testing(unittest.TestCase):
    ...
    def test_quit_message(self):
        """ Test quit message """
        outputexpected = "Exits the program with formatting"
        with patch("sys.stdout", new=StringIO()) as salida:
    ...
    def test_quit(self):
        ...
        self.assertFalse(HBNBCommand().onecmd("exit"))
    ...
    @unittest.skipIf(type(storage) == DBStorage, "DBStorage Test")
    def test_all(self):
        """Sir"""
    ...
    def test_update_function(self):
        ...
        with patch("sys.stdout", new=StringIO()) as salida:
            ...
            self.assertFalse(hasattr(test1, 'fn'))
            self.assertFalse(hasattr(test1, 'age'))
            self.assertFalse(hasattr(test1, 'w'))
        ...
        with patch("sys.stdout", new=StringIO()) as salida:
            ...
            self.assertFalse(hasattr(test2, 'fn'))
            self.assertFalse(hasattr(test2, 'w'))
        ...
        with patch("sys.stdout", new=StringIO()) as salida:
            HBNBCommand().onecmd('State.update("' + test3_id +
                                 '", {\'fn\': "facu", "age": 14, "w": 1.3})')
            self.assertFalse(hasattr(test3, 'fn'))
            self.assertFalse(hasattr(test3, 'age'))
            self.assertFalse(hasattr(test3, 'w'))
        ...
        with patch("sys.stdout", new=StringIO()) as salida:
            ...
            self.assertFalse(hasattr(test4, 'fn'))
            self.assertFalse(hasattr(test4, 'w'))
        ...
        with patch("sys.stdout", new=StringIO()) as salida:
            HBNBCommand().onecmd('Amenity.update("' + test5_id +
                                 '", {\'fn\': "mateo", "age": 21, "w": 18.7})')
            self.assertFalse(hasattr(test5, 'fn'))
            self.assertFalse(hasattr(test5, 'w'))
        ...
        with patch("sys.stdout", new=StringIO()) as salida:
            ...
            self.assertFalse(hasattr(test6, 'fn'))
            self.assertFalse(hasattr(test6, 'w'))
        ...
        with patch("sys.stdout", new=StringIO()) as salida:
            HBNBCommand().onecmd('Review.update("' + test7_id +
                                 '", {\'fn\': "mateo", "age": 21, "w": 18.7})')
            self.assertFalse(hasattr(test7, 'fn'))
            self.assertFalse(hasattr(test7, 'w'))
