...
class TestingBaseModel(unittest.TestCase):
    ...
    def test_SaveN7(self):
        ...
        self.assertTrue(hasattr(my_base24, "id"))
        self.assertTrue(hasattr(my_base24, "created_at"))
        self.assertTrue(hasattr(my_base24, "updated_at"))
    ...
    def test_str_method(self):
        ...
        self.assertEqual(my_base25printed,
                         s.format(my_base25.id, my_base25.to_dict()))
