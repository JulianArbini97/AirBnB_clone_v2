...
class TestingUser(unittest.TestCase):
    ...
    def test_User12(self):
        ...
        self.assertEqual(my_user13printed,
                         s.format(my_user13.id, my_user13.to_dict()))
    ...
    def test_init_kwargs(self):
        ...
        self.assertTrue(hasattr(my_user14, "id"))
        self.assertTrue(hasattr(my_user14, "created_at"))
        self.assertTrue(hasattr(my_user14, "updated_at"))
